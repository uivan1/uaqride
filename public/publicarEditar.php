	...
	<nav>
		...
		<button class="botonNav">Viajes Reservados</button>
			...
			<a href="verViajesPub.php">
				<input type="button" value="Tus Viajes Publicados" class="botonNav activo">
			</a>
			<a href="perfil.php">
		...
		<div class="viaje">
			...
			<div class="descViaje">
				<form action="../functions/funciones.php" method="post" onsubmit="return validar()">
					...
					<input type="submit" name="bandera" value="Modificar Viaje"

					class="btnPublicar">
					<input id="finalizarViaje" type="button" name="bandera" value="Finalizar Viaje"

					class="btnPublicar">
					<input id="eliminar" type="button" name="bandera" value="Eliminar Viaje"
...
<script src="js/publicarEditar.js"></script>
...
if (isset($_GET['t'])) {
    if ($_GET['t'] == 0) {
        ...
        echo "mensaje.innerHTML='Viaje Modificado exitosamente';";
